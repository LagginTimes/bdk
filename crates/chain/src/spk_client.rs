...
pub struct SyncRequest<B: AsRef<BlockId>>
where
    B: Clone,
{
...
pub struct SyncResult<B: AsRef<BlockId>, A = ConfirmationTimeHeightAnchor>
where
    B: Clone,
{
...
pub struct FullScanRequest<K, B: AsRef<BlockId>>
where
    B: Clone,
{
...
pub struct FullScanResult<K, B: AsRef<BlockId>, A = ConfirmationTimeHeightAnchor>
where
    B: Clone,
{
    /// The update to apply to the receiving [`LocalChain`](crate::local_chain::LocalChain).
